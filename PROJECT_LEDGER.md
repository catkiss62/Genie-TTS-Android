...
- 本地验证：新增报告格式/排名/相对基准/语义差异/单档失败继续 3 项 JUnit 测试，并通过独立 Kotlin/JUnit 4.13.2 运行。当前环境缺少缓存的 Android Gradle Plugin 8.7.3，完整 Android/Kotlin 编译需在获得本轮推送授权后交给 GitHub Actions；本轮尚未推送、未构建 APK。
